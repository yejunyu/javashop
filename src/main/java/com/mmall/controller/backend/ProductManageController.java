...
public class ProductManageController {
    ...
    @ResponseBody
    public Map richImgUpload(HttpSession session, MultipartFile file, HttpServletRequest request, HttpServletResponse response) {
...
//        }
        if (iUserService.checkAdminRole(user).isSuccess()) {
            ...
            resultMap.put("success", false);
            resultMap.put("msg", "无权操作，需要管理员权限");
            return resultMap;
        }
    }
}
