...
/*!40000 ALTER TABLE `mmall_category`
  DISABLE KEYS */;
...
VALUES (100001, 0, '家用电器', 1, NULL, '2017-03-25 16:46:00', '2017-03-25 16:46:00'),
  ...
  (100031, 0, 'test1', 1, NULL, '2018-03-07 16:17:24', '2018-03-07 16:17:24'),
  (100032, 0, 'test', 1, NULL, '2018-03-07 16:18:03', '2018-03-07 16:18:03');
/*!40000 ALTER TABLE `mmall_category`
  ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `mmall_order`
  DISABLE KEYS */;
INSERT INTO `mmall_order` (`id`, `order_no`, `user_id`, `shipping_id`, `payment`, `payment_type`, `postage`, `status`, `payment_time`, `send_time`, `end_time`, `close_time`, `create_time`, `update_time`)
VALUES
  ...
  (116, 1492091110004, 1, 29, 8598.00, 1, 0, 40, '2017-04-13 21:55:16', '2017-04-13 21:55:31', NULL, NULL,
   '2017-04-13 21:45:09', '2017-04-13 21:55:31'),
  (117, 1492091141269, 1, 29, 22894.00, 1, 0, 20, '2017-04-13 21:46:06', NULL, NULL, NULL, '2017-04-13 21:45:41',
   '2017-04-13 21:46:07');
/*!40000 ALTER TABLE `mmall_order`
  ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `mmall_order_item`
  DISABLE KEYS */;
...
VALUES (113, 1, 1491753014256, 26, 'Apple iPhone 7 Plus (A1661) 128G 玫瑰金色 移动联通电信4G手机',
  ...
  (134, 1, 1492091141269, 28, '4+64G送手环/Huawei/华为 nova 手机P9/P10plus青春', '0093f5d3-bdb4-4fb0-bec5-5465dfd26363.jpeg',
        1999.00, 2, 3998.00, '2017-04-13 21:45:41', '2017-04-13 21:45:41');
/*!40000 ALTER TABLE `mmall_order_item`
  ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `mmall_pay_info`
  DISABLE KEYS */;
INSERT INTO `mmall_pay_info` (`id`, `user_id`, `order_no`, `pay_platform`, `platform_number`, `platform_status`, `create_time`, `update_time`)
...
VALUES (26, 100002, 'Apple iPhone 7 Plus (A1661) 128G 玫瑰金色 移动联通电信4G手机', 'iPhone 7，现更以红色呈现。',
  ...
  (28, 100012, '4+64G送手环/Huawei/华为 nova 手机P9/P10plus青春', 'NOVA青春版1999元', '0093f5d3-bdb4-4fb0-bec5-5465dfd26363.jpeg',
  ...
  (29, 100008, 'Haier/海尔HJ100-1HU1 10公斤滚筒洗衣机全自动带烘干家用大容量 洗烘一体', '门店机型 德邦送货', '173335a4-5dce-4afd-9f18-a10623724c4e.jpeg',
  ...
  (30, 100002, 'iphoneX', 'xxxxxxxxxxxxxx', '1.jpg', '1.jpg,2.png', '好贵', 9999.99, 100, 4, '2018-03-08 18:16:59',
   '2018-03-08 18:16:59');
/*!40000 ALTER TABLE `mmall_product`
  ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `mmall_shipping`
  DISABLE KEYS */;
INSERT INTO `mmall_shipping` (`id`, `user_id`, `receiver_name`, `receiver_phone`, `receiver_mobile`, `receiver_province`, `receiver_city`, `receiver_district`, `receiver_address`, `receiver_zip`, `create_time`, `update_time`)
...
/*!40000 ALTER TABLE `mmall_user`
  DISABLE KEYS */;
INSERT INTO `mmall_user` (`id`, `username`, `password`, `email`, `phone`, `question`, `answer`, `role`, `create_time`, `update_time`)
VALUES (1, 'admin', '16556C6590F8CB018FCA21F53E706AC3', 'admin@happymmall.com', '13800138000', '问题', '答案', 0,
        '2016-11-06 16:56:45', '2017-04-04 19:27:36'),
  (13, 'geely', '16556C6590F8CB018FCA21F53E706AC3', 'geely@happymmall.com', '13800138000', '问题', '答案', 1,
   '2016-11-19 22:19:25', '2016-11-19 22:19:25'),
  (17, 'rosen', '16556C6590F8CB018FCA21F53E706AC3', 'rosen1@happymmall.com', '13800138000', '问题', '答案', 1,
   '2017-03-17 10:51:33', '2017-04-09 23:13:26'),
  (21, 'soonerbetter', '16556C6590F8CB018FCA21F53E706AC3', 'test06@happymmall.com', '13800138000', '105204', '105204',
   1, '2017-04-13 21:26:22', '2017-04-13 21:26:22'),
  (22, 'yejunyu', 'F866D731CA9CB6E7BED0B21351AC0189', '126.com', '1234567890', '1+2', '3', 0, '2018-03-07 10:48:20',
   '2018-03-07 16:06:33');
/*!40000 ALTER TABLE `mmall_user`
  ENABLE KEYS */;
UNLOCK TABLES;
